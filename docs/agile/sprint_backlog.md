...
| Create project structure for frontend and backend | David Maleka (Full Stack Developer) | 4 hrs | Sprint 1 | In Progress |
| Design database schema for menu and orders | Liyabona Miya (Backend Developer) | 6 hrs | Sprint 1 | In Progress |
| Implement API to retrieve food menu items | Liyabona Miya (Backend Developer) | 6 hrs | Sprint 1 | To Do |
