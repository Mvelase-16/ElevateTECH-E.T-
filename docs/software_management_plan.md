...
| Sprint 2 | Ordering (Cart & Time Slots) | Weeks 3–4 |
| Sprint 3 | Order Management | Weeks 5–6 |
| Sprint 4 | Polish & Extras |Weeks 7–8 |
| Sprint 5 | Testing & UAT | Weeks 9–10 |
| Sprint 6 | Launch & Documentation | Weeks 11–12 |

## Risk Management 
- Member Unavailability: Cross-train members and keep tasks small
- Missed deadline: Create weekly milestones
- Bugs: Do regular testing

## Technology Stack
- Frontend: React.js
- Backend: Node.js + Express
- Database: PostgreSQL
- Real-time/Auth: Supabase
